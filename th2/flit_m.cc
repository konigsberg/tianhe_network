...
void flit::copy(const flit& other)
{
    ...
    this->credit_vc = other.credit_vc;
}
...
void flit::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->credit_vc);
}
...
int flit::getCredit_os() const
{
    return this->credit_os;
}

void flit::setCredit_os(int credit_os)
{
    this->credit_os = credit_os;
}

int flit::getCredit_port() const
{
    return this->credit_port;
}

void flit::setCredit_port(int credit_port)
{
    this->credit_port = credit_port;
}

int flit::getCredit_vc() const
{
    return this->credit_vc;
}

void flit::setCredit_vc(int credit_vc)
{
    this->credit_vc = credit_vc;
}
